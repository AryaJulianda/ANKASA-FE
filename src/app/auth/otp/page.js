...
const Page = () => {
  ...
  return (
    ...
    <div className='w-2/5 max-xl:w-1/2 max-md:w-full min-h-full flex flex-col justify-center relative px-10 max-sm:px-7 py-10'>
      ...
      <div className=''>
        <h1 className='text-4xl max-sm:text-2xl max-sm:text-center font-semibold py-8 text-black'>Verification OTP</h1>
        <form className='flex flex-col gap-5'>
          ...
          <input 
            type="number" name="name" placeholder='OTP CODE' 
            className='border-b-2 border-gray-300 p-4 text-base focus:outline-none focus:border-primary remove-arrow'
          />   
